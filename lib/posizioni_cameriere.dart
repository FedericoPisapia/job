...
class PosizioniCameriere extends StatefulWidget {
  const PosizioniCameriere({Key? key, required this.sedi, required this.candidato}) : super(key: key);
  final List sedi;
                ...
                children: [
                  ...
                  TextButton(
                      onPressed: () {
                        ...
                        posizione.update("Titolo", (existingValue) => 'Cameriere di sala',);
                        posizione.update("SottoTitolo", (existingValue) => 'Per la sede di milano si cerca cameriere di sala con almeno 2 anni di esperienza',);
                        print(posizione);
                        Navigator.push(
                          context,
