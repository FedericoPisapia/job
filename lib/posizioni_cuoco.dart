              ...
              child: Column(
                children: [
                  ...
                  TextButton(
                      onPressed: () {
                        posizione.update("Sede", (existingValue) => 'Milano',);
                        posizione.update("Titolo", (existingValue) => 'Cuoco Secondi',);
                        posizione.update("SottoTitolo", (existingValue) => 'Per la sede di milano si cerca un cuoco specializzato nei secondi piatti della cucina milanese con ameno 2 anni di esperienza',);
                        print(posizione);
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FineCondizione(posizione: posizione,candidato : widget.candidato)),
            ...
            (widget.sedi.contains('Roma') ||
              ...
              child: Column(
                children: [
                  ...
                  TextButton(
                      onPressed: () {
                        posizione.update("Sede", (existingValue) => 'Roma',);
                        posizione.update("Titolo", (existingValue) => 'Cuoco Primi',);
                        posizione.update("SottoTitolo", (existingValue) => 'Per la sede di roma si cerca un cuoco specializzato nei primi piatti della cucina romana, con almeno 2 anni di esperienza',);
                        print(posizione);
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FineCondizione(posizione: posizione,candidato : widget.candidato)),
